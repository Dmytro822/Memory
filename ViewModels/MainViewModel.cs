...
namespace Memo.ViewModels
{
    internal class MainViewModel : ViewModel
    {
        ...
        {
            MessageBoxResult results = MessageBox.Show("Розпочати знову", "Кінець гри", MessageBoxButton.YesNo);
        ...
        public void CheckPoint()
        {
            ...
            if (count == 30)
            {
                ...
                {
                    MessageBox.Show("Перший гравець виграв!");
                    RestartGame();
                }
                else if (pointPlayer1 < pointPlayer2)
                {
                    MessageBox.Show("Другий гравець виграв!");
                    RestartGame();
                }
            }
        }
